...
b,function(b){b.success?a.after(b.spisok).remove():a.removeClass("busy")},"json"))}).on("click","#client #filter_clear",function(){$("#find")._search("clear");clientSpisok()}).on("click","#setup_category .add",function(){function a(){var a={op:"category_add",name:$("#name").val()};a.name?(b.process(),$.post(AJAX_SETUP,a,function(a){a.success?($(".spisok").html(a.html),b.close(),_msg("Внесено!"),sortable()):b.abort()},"json")):(b.bottom.vkHint({msg:"<SPAN class=red>Не указано наименование</SPAN>",
top:-47,left:120,indent:50,show:1,remove:1}),$("#name").focus())}$(this);var b=_dialog({width:440,head:"Добавление нового категории",content:'<table class="setup-tab"><tr><td class="label r">Наименование:<td><input id="name" type="text" maxlength="200" /></table>',submit:a});$("#name").focus().keyEnter(a)}).on("click","#setup_category .img_edit",function(){function a(){var a={op:"category_edit",id:c,name:$("#name").val()};a.name?(d.process(),$.post(AJAX_SETUP,a,function(a){a.success?($(".spisok").html(a.html),
...
submit:a});$("#name").focus().keyEnter(a)}).on("click","#setup_category .img_del",function(){var a=$(this),b=_dialog({top:90,width:300,head:"Удаление категории",content:"<center><b>Подтвердите удаление категории.</b></center>",butSubmit:"Удалить",submit:function(){for(;"DD"!=a[0].tagName;)a=a.parent();var c={op:"category_del",id:a.attr("val")};b.process();$.post(AJAX_SETUP,c,function(a){a.success?($(".spisok").html(a.html),b.close(),_msg("Удалено."),sortable()):b.abort()},"json")}})}).ready(function(){$("#client").length&&
